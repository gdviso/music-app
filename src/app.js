...
const spotifyKey = 'Basic OWMzMWViODNkNDZjNDdkYmE5YTRmZjcyMmRlZjExMTk6MTlmODhiYTQ1ZjJiNGY5ZWJiMjI4MjE4MWU1MmIyYWE=';
...
class App extends React.Component {
			...
			return (
				<div key={song.track_id}>
					<div className="songContainer animated zoomIn">
						<PicAndLink 
							index={i} 
							getAlbumArtwork={this.getAlbumArtwork} 
							artistPic={ogSong.pic} 
							artistLink={ogSong.link} 
							data={song}
						/>
	...
	render() {
		...
		if (this.state.loggedin === true) {
			logTitle = (<h2 className="myMusicTitle">My Music</h2>)
		}
		if (this.state.loggedin === false) {
			notice=(<p className="notice">Create an account or login to be able to save songs!</p>)
		}
		return (
			<div className="main">
				<Header/>
				...
				<footer>
					<p>Done by <a href="https://gusdom.com/">Gustavo Dominguez</a> using <a href="https://www.musixmatch.com/">Musixmatch's</a> & <a href="https://www.spotify.com">Spotify's</a> API</p>
				</footer>
			</div>
		)
	}
